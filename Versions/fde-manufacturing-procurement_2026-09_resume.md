...
- Utilized VBA and Excel programming alongside transmission line rating engineering knowledge to design and build an auditable, automated FERC-881 steady-state line-rating tool from scratch - integrating PLS-CADD structure data, conductor properties, and historical weather data with CIGRE-referenced seasonal rating methodology to compute normal and emergency ratings and critical-span summaries - reducing engineering hours threefold and costs by $1.5M.
- Utilized high-level knowledge of transmission line design to scope new lines with other engineering disciplines.
- Utilized in-depth knowledge of PLSCADD, L-PILE, NESC, and GO-95 for design of new power transmission lines and rebuilding/maintenance of existing lines across six Western states in collaboration with teams of engineers, managers, field crew, and legal.
- Utilized structural/geotechnical engineering knowledge for custom-engineered transmission structures and drilled piers per ASCE, ACI, and FHWA standards.
...
- Proposed, secured funding, planned, and oversaw student events in collaboration with industry, academia, businesses, and nonprofits.
