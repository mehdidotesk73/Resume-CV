...
\begin{rlist}
  ...
  \item Architected a git-inspired version-control framework for Foundry system-analysis lifecycles, supporting cloning, modification, and staged publication through department-specific review checkpoints, with automated resource tracking and validation.
...
\subline{University of Colorado Boulder, Boulder, CO}
\begin{rlist}
  \item Proposed, secured funding, planned, and oversaw student events with industry, academic, business, and nonprofit partners.
\end{rlist}
