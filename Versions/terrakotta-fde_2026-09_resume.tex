...
\subline{PacifiCorp}
\begin{rlist}
  \item Applied full-stack TypeScript and Python engineering to design, build, and deploy a Foundry-based data management system end-to-end - from backend pipelines through user-facing UIs - covering audit preparation, interdepartmental data collection, and queue-based processing pipelines.
