...
\subline{PacifiCorp}
\begin{rlist}
  \item Utilized VBA and Excel programming alongside transmission line rating engineering knowledge to design and build an auditable, automated FERC-881 steady-state line-rating tool from scratch - integrating PLS-CADD structure data, conductor properties, and historical weather data with CIGRE-referenced seasonal rating methodology to compute normal and emergency ratings and critical-span summaries - reducing engineering hours threefold and costs by \$1.5M.
  \item Utilized high-level knowledge of transmission line design to scope new lines with other engineering disciplines.
  \item Utilized in-depth knowledge of PLSCADD, L-PILE, NESC, and GO-95 for design of new power transmission lines and rebuilding/maintenance of existing lines across six Western states in collaboration with teams of engineers, managers, field crew, and legal.
  \item Utilized structural/geotechnical engineering knowledge for custom-engineered transmission structures and drilled piers per ASCE, ACI, and FHWA standards.
  ...
  \item Designed and reviewed drawings for tubular steel poles and drilled piers to withstand vertical and lateral loads.
  \item Performed detail-oriented technical review of transmission standards and collaboration in their developments.
  \item Initiated process improvement pipelines for transmission design processes and documentations.
...
\subline{University of Colorado Boulder, Boulder, CO}
\begin{rlist}
  \item Proposed, secured funding, planned, and oversaw student events in collaboration with industry, academia, businesses, and nonprofits.
\end{rlist}
