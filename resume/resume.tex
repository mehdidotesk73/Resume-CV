...
\subline{PacifiCorp}
\begin{rlist}
  \item Applied full-stack TypeScript and Python engineering to design and implement automated Foundry and custom-software workflows, covering audit preparation, data management UIs, interdepartmental data collection, and queue-based processing pipelines.
